...
Route::middleware(['tenant', 'session.logout'])->group(function () {
    Route::prefix('tenants')->group(function () {
        ...
        Route::get('/user/manual', [TenantController::class, 'manualView'])->name('tenant.manual');
        ...
        Route::middleware(['checkComplete'])->group(function () {
            ...
            Route::post('/website/review',[RatingController::class, 'websiteReview'])->name('website.review.tenant');
