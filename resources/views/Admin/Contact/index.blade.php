<x-users.main.app-layout>
    ...
    <x-admin.banners>
        <x-slot name="name">All Contact</x-slot>
    </x-admin.banners>
                           
    <x-landlords.responsive-table>
        <x-slot name="heading">All Contact</x-slot>
        <x-slot name="thead">
            <tr>
                <th>S.N</th>
                <th>User Name</th>
        ...
        <x-slot name="tbody">
            @foreach ($contacts as $contact)
                <tr>
                    ...
                    <td data-name="User Name">{!! $contact->first_name !!} {!! $contact->last_name !!}</td>
                    ...
                    <td class="table-action-cell">
                        <a href="{{ route('admin.email.send.id', $contact->email) }}" class="table-btns">
                        ...
                        <form action="{{ route('admin.contact.destroy', $contact) }}" method="POST" class="table-btns danger" id="deleteTables{!! $contact->id !!}">
                            @csrf
                            @method('DELETE')
                            <button type="button" class="none" onclick="return confirmDelete('deleteTables{!! $contact->id !!}')">
                                <span class="action-icons">
