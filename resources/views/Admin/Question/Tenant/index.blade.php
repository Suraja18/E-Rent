<x-users.main.app-layout>
    ...
    <x-admin.banners>
        <x-slot name="name">Tenants Questions</x-slot>
    </x-admin.banners>
                           
    <x-landlords.responsive-table>
        <x-slot name="links">{!! route('question.create') !!}</x-slot>
            ...
            @foreach ($frequentlies as $frequently)
                <tr>
                    ...
                    <td class="table-action-cell">
                        <a href="{!! route('question.show', $frequently) !!}" class="table-btns">
                        ...
                        <a href="{{ route('question.edit', $frequently) }}" class="table-btns edits">
                            <span class="action-icons">
                        ...
                        <form action="{{ route('question.destroy', $frequently) }}" method="POST" class="table-btns danger" id="deleteTables{!! $frequently->id !!}">
                            @csrf
                            @method('DELETE')
