<x-users.main.app-layout>
    ...
    <x-landlords.new-body>
        <form enctype="multipart/form-data" action="{{ route('policy.update', $policy) }}" method="POST">
            @method('PUT')
            @csrf
            <div class="admin">
                <h4 class="mb-1">Title</h4>
                <input placeholder="Write title here..." name="title" value="{!! $policy->title !!}" class="form-control" required />
                @error('title')
