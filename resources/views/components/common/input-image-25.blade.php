<div class="admin">
    ...
    <div class="add-img-container">
        ...
        <div class="add-flex-4">
            <x-common.input-file-flex><x-slot name="image">Image 3</x-slot><x-slot name="type2">empty</x-slot></x-common.input-file-flex>
        </div>
        <div class="add-flex-4">
            <x-common.input-file-flex><x-slot name="image">Image 4</x-slot><x-slot name="type2">empty</x-slot></x-common.input-file-flex>
        </div>
    </div>
    @if(isset($type))
    @else
