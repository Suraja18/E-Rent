...
<section class="Nav-Navbar">
    ...
    <div class="nav-more-options" id="navMoreOptions">
        ...
        <div class="nav-mobile-grid" role="list">
            ...
            <div class="nav-mobile-grid" role="listitem">
                <div class="nav-mobile-below-whole-containers">
                    <a href="{{ route('user.services') }}" class="nav-icons-for-mobile @if(Route::currentRouteName() == 'user.services') active @endif">
                                ...
                                <div class="header-tag-list">
                                    ...
                                    <div class="header-subheader-list">
                                        <a href="{{ route('user.services') }}"
                                            ...
                                            <div class="sub-item_text">
                                                <div
                                                    class="text-testimonial nav-primary is-green-text-on-hover @if(Route::currentRouteName() == 'user.services') active @endif">Services</div>
                                                <div
                                                    class="text--xxs nav-sub">Services E-Rent Offers</div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="header-subheader-list">
                        ...
                        <a class="navigationMenu-items inline-block is-pages">
                            ...
                            <div class="navbar-submenu-list is-page-subnav">
                                ...
                                <div class="navbar-header-tag" onclick="window.location.href='{{ route('user.services') }}';">
                                    <div class="text-testimonial nav-primary is-green-text-on-hover @if(Route::currentRouteName() == 'user.services') active @endif">Services</div>
