...
<section id="landlordBody" class="special-container">
    ...
    <div class="nav-more-options" id="navMoreOptions">
        ...
        <div class="nav-mobile-grid" role="list">
            ...
            <div class="nav-mobile-grid" role="listitem">
                <div class="nav-mobile-below-whole-containers">
                    <a href="{{ route('landlord.unit.index') }}" class="nav-icons-for-mobile @if(request()->routeIs('landlord.unit.*')) active @endif">
            ...
            <div class="nav-mobile-grid" role="listitem">
                <div class="nav-mobile-below-whole-containers">
                    <a href="{!! route('landlord.rating.index') !!}" class="nav-icons-for-mobile @if(request()->routeIs('landlord.rating.*')) active @endif">
