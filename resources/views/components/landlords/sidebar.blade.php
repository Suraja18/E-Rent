                ...
                <div class="sidebar-content-wrapper flex-cl-1">
                    <nav class="sidebar-content-row o-hidden">
                        <ul class="sidebar-content-menu menu-list" role="list">
                                ...
                                <div class="sidebarDropdown" id="sidebarDropdown-maintenance">
                                    <ul class="sidebar-content-menu sub-menu">
                                        <li role="list" class="for-list">
                                            <a href="{!! route('approve.index') !!}" class="sidebar-link @if(request()->routeIs('approve.*')) active @endif" role="listitem">
                                                <div class="sidebar-content-linkitem p-r">
                                            ...
                                            <a href="{!! route('landlord.maintenance.index') !!}" class="sidebar-link @if(request()->routeIs('landlord.maintenance.index')) active @endif" role="listitem">
                                                <div class="sidebar-content-linkitem p-r">
                                            ...
                                            <a href="{!! route('landlord.maintenance.complete') !!}" class="sidebar-link @if(request()->routeIs('landlord.maintenance.complete')) active @endif" role="listitem">
                                                <div class="sidebar-content-linkitem p-r">
                            ...
                            <li class="mb-5 o-hidden" role="listitem">
                                <span class="sidebar-link @if(request()->routeIs('building.*') || request()->routeIs('landlord.unit.*')) active @endif" id="dropdownproperty">
                                    <div class="sidebar-content-linkitem p-r">
                                ...
                                <div class="sidebarDropdown" id="sidebarDropdown-property">
                                    <ul class="sidebar-content-menu sub-menu">
                                        <li role="list" class="for-list">
                                            ...
                                            <a href="{{ route('landlord.unit.index') }}" class="sidebar-link @if(request()->routeIs('landlord.unit.*')) active @endif" role="listitem">
                                                <div class="sidebar-content-linkitem p-r">
                            ...
                            <li class="mb-5 o-hidden" role="listitem">
                                <a href="{!! route('landlord.rating.index') !!}" class="sidebar-link @if(request()->routeIs('landlord.rating.*')) active @endif">
                                    <div class="sidebar-content-linkitem p-r">
                            ...
                            <li class="mb-5 o-hidden" role="listitem">
                                <a href="{!! route('landlord.manual') !!}" class="sidebar-link @if(request()->routeIs('landlord.manual')) active @endif">
                                    <div class="sidebar-content-linkitem p-r">
                                    ...
                                    <span class="sidebar-content-header"> User Manual </span> 
                                </a>
                            </li>
                            <li class="mb-5 o-hidden" role="listitem">
