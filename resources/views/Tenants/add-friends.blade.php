                                        ...
                                        <div class="col-25 animate wow fadeInUp" data-wow-delay="0.1s" role="listitem">
                                            <div class="landlord-containers">
                                                ...
                                                <div class="text-center landlord-wrappers">
                                                    ...
                                                    <button type="button" class="remove-request is-button-for-edit-profile wid100" data-request-id="{!! $friend->friends[0]->user_id !!}">Remove</button>
                                                </div>
                                            </div>
                                        </div> 
                                    @endif
    ...
    <script>
        $(document).ready(function() {
            $('.confirm-request, .remove-request').on('click', function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{!! route('user.updateFriendRequest') !!}',
                    data: {
                    ...
                    success: function(data) {
                        ...
                        $('.is-button-for-edit-profile[data-friend-id="' + requestId + '"]').show().text(data.message);
                    },
