    ...
    <x-tenants.navbar />
     ...
     <div class="is-tenant-banners">
        <div class="is-header-all-container">
            <div class="pt-20p hide">
                <ul class="banner-header-links">
                    ...
                    <li class="banner-header-name">
                        /<span class="banner-link-for-header for-normal">Payment</span>
                    </li>
                </ul>
            </div>
        </div>
        <div class="is-header-all-wrappers">
            <div class="is-header-all-wrappers">
                <div>
                    <h2 class="header-f0r-mobile text-center">All Payment</h2>
                        ...
                        <div class="is-header-all-container padding">
                            <header class="header-u-flex">
                                <div class="header-left-side-wrap">
                                    <div class="header-left-title">All Payment</div>
                                    <p>{!! $count !!} Total</p>
                                </div>
                            </header>
                                    ...
                                    @foreach ($payments as $payment)
                                        <tr>
                                            ...
                                            <td class="table-action-cell">
                                                <a href="{!! route('tenant.payment_history.show', $payment) !!}" class="table-btns">
                                                ...
                                                <form action="{{ route('tenant.payment.destroy', $payment) }}" method="POST" class="table-btns danger" id="deleteTables{!! $payment->id !!}">
                                                    @csrf
                                                    @method('DELETE')
