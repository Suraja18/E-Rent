                                                                    ...
                                                                    <div class="send-msg">
                                                                        <div class="p-r">
                                                                            <div class="d-flex">
                                                                                ...
                                                                                <button type="button" class="msg-send-svg b-e-0 btnSend">
                                                                ...
                                                                <div>
                                                                    <div class="send-msg"> 
                                                                        <div class="p-r">
                                                                            <div class="d-flex">
                                                                                <button class="b-e-0">
                                                                                    <input type="file" name="image_upload" id="image_upload_{{ $contact->id }}" style="display: none;" accept="image/*" onchange="previewImage({{ $contact->id }});">
...
<script>
    ...
    $(document).ready(function() {
        $('.chat-container').on('click', '.btnSend', function() {
            ...
            var imageInput = document.getElementById('image_upload_' + friendId);
