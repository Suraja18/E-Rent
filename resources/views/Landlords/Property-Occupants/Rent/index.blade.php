<x-users.main.app-layout>
    ...
    <x-landlords.banners>
        <x-slot name="name">Property Rent</x-slot>
    </x-landlords.banners>
                           
    <x-landlords.responsive-table>
        <x-slot name="links">{!! route('rent.create') !!}</x-slot>
                ...
                <tr>
                    ...
                    <td class="image-table-cell">
                        <div class="table-images">
                            <img src="{!! asset($rent->image_1) !!}" class="tables-image-round" alt="{!! $rent->rent_name !!}">
                        </div>
                    </td>
                    ...
                    <td class="table-action-cell">
                        <a href="{!! route('rent.show', $rent) !!}" class="table-btns">
                        ...
                        <a href="{{ route('rent.edit', $rent) }}" class="table-btns edits">
                            <span class="action-icons">
                        ...
                        <form action="{{ route('rent.destroy', $rent) }}" method="POST" class="table-btns danger" id="deleteTables{!! $rent->id !!}">
                            @csrf
                            @method('DELETE')
