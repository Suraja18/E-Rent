            ...
            @foreach ($payments as $payment)
                <tr>
                    ...
                    <td class="table-action-cell">
                        <a href="{!! route('building.show', $payment) !!}" class="table-btns">
                        ...
                        <form action="{{ route('building.destroy', $payment) }}" method="POST" class="table-btns danger" id="deleteTables{!! $payment->id !!}">
                            @csrf
                            @method('DELETE')
