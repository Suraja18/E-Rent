<x-users.main.app-layout>
    ...
    <x-landlords.banners>
        <x-slot name="name">View Maintenance Request</x-slot>
    </x-landlords.banners>
                            ...
                            <div class="upper-section-view-maintain">
                                <header class="header-panel-maintain is-header-req">
                                    <div style="display: block; margin-right: 10px;">
                                        <a href="@if($requests->status == "Completed"){!! route('landlord.maintenance.complete') !!} @else {!! route('landlord.maintenance.index') !!} @endif" class="btn-back">
