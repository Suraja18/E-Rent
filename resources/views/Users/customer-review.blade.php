<x-users.main.app-layout>
            ...
            <div class="container is-header">
                <div class="hero-content housing-content-center">
                    <div class="hero-content housing-content-center housing-detail">
                        ...
                        <p class="text-testimonial text-center">Businesses just like yours have found solutions with HappyCo. See how our customers are experiencing success with their property operations.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="client-header pt-5b">
        <div class="hero-content mt-3 text-center">
            ...
            <a href="../Errors/404Error.html" class="btnPrimary get-in-touch inline-block"><div class="btn_text">Get in Touch</div></a>
        </div>
    </section>
    <!-- End Get in Touch -->
